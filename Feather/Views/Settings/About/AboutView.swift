...
struct AboutView: View {
	...
	private let _creditsUrl = "https://raw.githubusercontent.com/AbdTench/Feather/refs/heads/main/credits.json"
	private let _donatorsUrl = "https://raw.githubusercontent.com/AbdTench/Feather/refs/heads/main/sponsors.json"
		...
		NBList(.localized("About")) {
			if !isLoading {
				...
				NBSection(.localized("Sponsors")) {
					...
					Text("❤️ شكراً لكل من دعم Swift Store!")
						.foregroundStyle(.secondary)
						.padding(.vertical, 2)
				}
			}
